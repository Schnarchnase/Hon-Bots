...
shopping.Setup(true, false, true, true)
...
function object:oncombateventOverride(EventData)
	...
	elseif EventData.Type == "Item" then
		local itemSheepstick = itemHandler:GetItem("Item_Morph")
		if itemSheepstick and EventData.SourceUnit == core.unitSelf:GetUniqueID() and EventData.InflictorName == itemSheepstick:GetName() then
